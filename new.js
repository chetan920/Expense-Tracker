...
function update(i) {
  if (localStorage.getItem("arr")) {
    const parsedArr = JSON.parse(localStorage.getItem("arr"));
    const updatedExpName = prompt("enter new value", parsedArr[i].expenceProduct);
    const updatedExprice = prompt("enter new value", parsedArr[i].expencePrice);
